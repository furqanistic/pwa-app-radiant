          ...
          <div className='lg:col-span-1'>
            <BNPLBanner className="mb-4" />
              ...
              <button
                ...
                disabled={isProcessing}
                className='w-full h-10 rounded-lg border border-gray-200/70 bg-white text-gray-800 font-semibold hover:bg-gray-50 transition-colors disabled:cursor-not-allowed disabled:opacity-50'
              >

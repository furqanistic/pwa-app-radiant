  ...
  return (
    <Layout>
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[color:var(--brand-primary)/0.08] to-white -z-10" />
        <div className="absolute top-0 inset-x-0 h-64 bg-gradient-to-b from-[color:var(--brand-primary)/0.12] to-transparent -z-10" />
        
        {/* 2. Confetti Layer */}
        <ConfettiCanvas colors={[brandColor, brandColorDark, '#fcd34d', '#ffffff']} />
        ...
        >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[color:var(--brand-primary)] to-[color:var(--brand-primary-dark)] blur-2xl opacity-20 transform scale-110 rounded-[3rem]" />
            ...
            <div className="bg-white/80 backdrop-blur-xl border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2.5rem] p-8 text-center relative overflow-hidden">
                ...
                {sessionId && (
                    <motion.div 
                        ...
                        className="relative z-10 bg-gray-50 rounded-2xl py-3 px-4 mb-8 border border-gray-200/70 flex flex-col items-center gap-1"
                    >
                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Order ID</span>
                        <code className="text-xs font-mono text-gray-600 bg-white px-2 py-0.5 rounded border border-gray-200/70 select-all">
                ...
                <div className="relative z-10 space-y-3">
                    ...
                    <motion.button
                        ...
                        className="w-full bg-transparent hover:bg-[color:var(--brand-primary)/0.08] text-gray-600 hover:text-[color:var(--brand-primary)] py-3 rounded-2xl font-bold transition-all flex items-center justify-center gap-2"
                    >

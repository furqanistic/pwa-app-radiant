                        ...
                        <div className="text-center space-y-6">
                            {result.success ? (
                                ...
                                <>
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-bold text-amber-700 mb-2">Claim Limit Reached</h3>
                                    ...
                                    <div className="bg-amber-50 rounded-xl p-4 border border-amber-200">
                                        ...
                                        <p className="text-xs text-amber-700 mt-1">
                                            To ensure fair play and prevent abuse, points can only be claimed once every 15 hours at each location. This helps us maintain a balanced rewards system for all users.
                                        </p>
                                    </div>
                                </>
                            ) : (

...
const STORAGE_KEYS = {
  DISMISSED: 'cxr-install-dismissed',
  SUCCESS_SHOWN: 'cxr-install-success-shown',
  NEVER_SHOW: 'cxr-install-never-show',
}
...
const InstallPrompt = () => {
  ...
  const appDisplayName = spaNameFromUser || branding?.name?.trim() || 'CxR systems'
  ...
  useEffect(() => {
    ...
    window.addEventListener('cxr:open-install-prompt', openPromptFromButton)
    return () =>
      window.removeEventListener(
        'cxr:open-install-prompt',

  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="z-[120] p-0 overflow-hidden flex flex-col h-[100dvh] max-h-[100dvh] w-screen max-w-none rounded-none fixed inset-0 translate-x-0 translate-y-0 border-0 shadow-none bg-white sm:h-[96vh] sm:w-[98vw] sm:rounded-[1.2rem] sm:inset-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:shadow-2xl"
      >
        <div className="relative z-10 flex shrink-0 items-center justify-between border-b border-gray-100 bg-white px-4 py-2.5 sm:px-5 sm:py-3">

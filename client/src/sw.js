...
const CACHE_NAME = 'CxR Systems-v1'
...
self.addEventListener('push', (event) => {
  ...
  try {
    ...
    event.waitUntil(
      self.registration.showNotification('CxR Systems', {
        body: text,
